...
"
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-4 py-9">
        <div className="lg:max-w-[410px]">
          <p className="font-[700] text-[40px] text-[#172755]">
        ...
        <Image src={screen1} alt="desc" className="w-[600px] h-[400px]" />
      </div>

      <div className="flex flex-col md:flex-row justify-start items-center gap-4 py-9">
        <Image
          src={screen2}
          alt="desc"
          className="w-[600px] h-[400px] lg:mr-7"
        />
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-9">
        ...
        <Image src={screen3} alt="desc" className="w-[600px] h-[400px]" />
      </div>
    </div>
  );
};
